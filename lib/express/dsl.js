...
var express = require('express/core')
...
function route(method) {
  return function(path, options, callback){
    ...
    Express.routes.push(new express.Route(method, path, callback, options))
  }
}
...
exports.run = function() {
  exports.configure(Express.environment = process.env.EXPRESS_ENV || 'development')
