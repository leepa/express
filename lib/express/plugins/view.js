...
exports.View = Plugin.extend({
  extend: {
    ...
    init: function() {
      ...
      if (!express.set('views'))
        express.set('views', function(){
          return express.set('root') + '/views'
        })
        
      if (!express.set('partials'))
        express.set('partials', function(){
          return express.set('views') + '/partials'
        })
        
      // Cache views in memory
      
      if (express.set('cache view contents'))
        cacheFiles('views')
        
      if (express.set('cache view partials'))
        cacheFiles('partials')
